...
LiveSphereCtrl.$inject = ["$timeout", "$scope", "$rootScope", "envService", "$stateParams", "ngMeta", "lptSphere", "LptHelper", "$http", "Alertify", "project"];
angular.module('lapentor.livesphere')
    .controller('LiveSphereCtrl', LiveSphereCtrl);

function LiveSphereCtrl($timeout, $scope, $rootScope, envService, $stateParams, ngMeta, lptSphere, LptHelper, $http, Alertify, project) {
    var vm = this,
...
ProfileCtrl.$inject = ["Alertify", "envService", "Upload", "user", "User", "LptHelper"];
angular.module('lapentor.app')
    .controller('ProfileCtrl', ProfileCtrl);

function ProfileCtrl(Alertify, envService, Upload, user, User, LptHelper) {
    var vm = this;
    vm.user = user;
    vm.invoices = [];
